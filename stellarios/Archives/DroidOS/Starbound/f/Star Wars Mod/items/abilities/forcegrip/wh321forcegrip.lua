...
function ControlProjectile:discharge()
  ...
  local damageListener = damageListener("damageTaken", function(notifications)	--wh321
...
function ControlProjectile:targetValid(aimPos)
  ...
  local valTar
  if wh321util.targetAtPos(aimPos, 1) == 0 then valTar = false else valTar = true end
